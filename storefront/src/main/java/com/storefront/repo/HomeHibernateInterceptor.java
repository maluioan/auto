...
// TODO: put this into a common place
public interface HomeHibernateInterceptor<T extends BaseData> extends Interceptor {
    ...
    default boolean onFlushDirty(Object o, Serializable serializable, Object[] objects, Object[] objects1, String[] strings, Type[] types) throws CallbackException {
        ...
        return o.getClass().isAssignableFrom(BaseData.class) && onFlushDirtyInternal((T) o, serializable, objects, objects1, strings, types);
    }
    ...
    default boolean onSave(Object o, Serializable serializable, Object[] objects, String[] strings, Type[] types) throws CallbackException {
        ...
        return o.getClass().isAssignableFrom(BaseData.class) && onSaveInternal((T) o, serializable, objects, strings, types);
    }
